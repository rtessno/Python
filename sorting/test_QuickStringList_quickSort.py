...
print("timeit test, testing bubble_string_list.QuickStringList.quickSort()")
t = timeit.Timer("bubble_string_list.QuickStringList.quickSort(bubble_string_list.obj_list)", "import bubble_string_list")
