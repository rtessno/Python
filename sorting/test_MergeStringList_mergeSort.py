...
print("timeit test, testing bubble_string_list.MergeStringList.mergeSort()")
t = timeit.Timer("bubble_string_list.MergeStringList.mergeSort(bubble_string_list.obj_list)", "import bubble_string_list")
